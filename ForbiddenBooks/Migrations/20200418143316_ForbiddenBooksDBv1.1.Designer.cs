...
namespace ForbiddenBooks.Migrations
{
    ...
    [Migration("20200418143316_ForbiddenBooksDBv1.1")]
    partial class ForbiddenBooksDBv11
    {
            ...
            modelBuilder.Entity("ForbiddenBooks.DatabseLogic.Tables.Magazine", b =>
                {
                    ...
                    b.HasOne("ForbiddenBooks.DatabseLogic.Tables.Market", "marketOwner")
                        .WithMany("Magazines")
                        .HasForeignKey("marketOwnerId");

                    b.HasOne("ForbiddenBooks.DatabseLogic.Tables.User", "userOwner")
                        .WithMany("Magazines")
